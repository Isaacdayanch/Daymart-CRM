...
10. **Hoja de revisión de inventario** (`/stock/imprimir`): imprimible, sin precios ni costos — solo SKU, producto, piezas y cajas según el sistema, más una columna en blanco para anotar el conteo físico. Pensada para auditar bodega a mano.
